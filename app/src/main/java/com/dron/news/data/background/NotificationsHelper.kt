...
import com.dron.news.R
import com.dron.news.presentation.MainActivity
import com.dron.news.presentation.screen.subscriptions.SubscriptionCommand
...
class NotificationsHelper @Inject constructor(
    ...
    fun createNotificationChannel() {
        val channel = NotificationChannel(
            ...
            description = "Уведомления о новых статьях"
        }

        notificationManager?.createNotificationChannel(channel)
    }

    fun showNewArticlesNotification(topic: List<String>) {
